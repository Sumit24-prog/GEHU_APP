...
import com.sumit.gehu.ebook.EbookActivity;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.navigation_share:
                String url = "https://drive.google.com/drive/folders/1mB9zYvTRiEg4XTcrANbS2floOgWOYpsg?usp=sharing";
